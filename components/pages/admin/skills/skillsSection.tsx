                        ...
                        {skills && skills.length > 0 ? (
                            <ul className="mt-4 space-y-2">
                                {skills.map((skill, index) => (
                                    <li key={index} className="text-gray-300 block w-full border border-gray-600 rounded-md px-4 py-2 hover:bg-gray-600 transition-colors">
                                        {skill}
                                    </li>
                                ))}
                            </ul>
                        ) : (
                            <p className="text-gray-400 py-4">You haven't added any skills yet. Start by clicking the "Add New Skill" button above!</p>
                        )}
                    </div >
                </div>
  )
